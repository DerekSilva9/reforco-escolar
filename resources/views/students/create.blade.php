                    ...
                    <form method="POST" action="{{ route('alunos.store') }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="flex items-center gap-2 mt-6">
                                <input id="active" name="active" type="checkbox" value="1" class="rounded border-blue-200 text-blue-900 shadow-sm focus:ring-blue-700" @checked(old('active', true)) />
                        ...
                        <div>
                            ...
                            <textarea id="notes" name="notes" rows="4" class="mt-1 block w-full border-blue-200 focus:border-blue-700 focus:ring-blue-700 rounded-md shadow-sm bg-white">{{ old('notes') }}</textarea>
