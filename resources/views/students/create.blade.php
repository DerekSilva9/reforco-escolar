        ...
        <div class="max-w-3xl mx-auto px-3 md:px-6 lg:px-8">
            <div class="bg-white/90 dark:bg-slate-800/90 backdrop-blur overflow-hidden shadow-sm sm:rounded-lg border border-blue-100 dark:border-slate-700">
                <div class="p-4 md:p-6 text-slate-900 dark:text-slate-50">
                    <form method="POST" action="{{ route('alunos.store') }}" class="space-y-4 md:space-y-6">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <x-text-input id="school_year" name="school_year" type="text" class="mt-1 block w-full" :value="old('school_year')" placeholder="Ex: 1º ano, 2º série" />
                                <x-input-error class="mt-2" :messages="$errors->get('school_year')" />
                            </div>

                            <div>
                                <x-input-label for="school" value="Escola (opcional)" />
                                <x-text-input id="school" name="school" type="text" class="mt-1 block w-full" :value="old('school')" />
