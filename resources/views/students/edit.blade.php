        ...
        <div class="max-w-3xl mx-auto px-3 md:px-6 lg:px-8">
            <div class="bg-white/90 dark:bg-slate-800/90 backdrop-blur overflow-hidden shadow-sm sm:rounded-lg border border-blue-100 dark:border-slate-700">
                <div class="p-4 md:p-6 text-slate-900 dark:text-slate-50">
                    <form method="POST" action="{{ route('alunos.update', $student) }}" class="space-y-4 md:space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="flex items-center gap-2 mt-6">
                                <input id="active" name="active" type="checkbox" value="1" class="rounded border-blue-200 dark:border-slate-600 text-blue-900 dark:text-blue-600 shadow-sm focus:ring-blue-700 dark:focus:ring-blue-500" @checked(old('active', $student->active)) />
